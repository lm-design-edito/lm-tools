...
/**
 * Callback function invoked at each step of a transition.
 *
 * @param val - The current eased value of the transition.
 * @param timeMs - The timestamp (in milliseconds) when this step occurs.
 */
export type Callback = (val: number, timeMs: number) => void

/**
 * Predefined easing function names for transitions.
 * Used to control the acceleration pattern of a transition.
 */
export enum Ease {
  LINEAR = 'linear',
...
/**
 * A function that maps a progress value between 0 and 1 to an eased progress value.
 *
 * @param progress - Progress of the transition from 0 (start) to 1 (end).
 * @returns The eased progress value.
 */
export type EasingFunction = (progress: number) => number

/**
 * Dictionary mapping string keys to easing functions.
 */
...
/**
 * Mapping from `Ease` enum values to easing functions.
 */
