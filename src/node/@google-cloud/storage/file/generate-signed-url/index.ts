 ...
 *
 * @param bucket - The Google Cloud Storage bucket object containing the file.
 * @param sourcePath - The path of the file for which the signed URL is being generated.
 * @param action - The action allowed by the signed URL (e.g., 'read', 'write', 'delete').
 * @param expiresOn - The expiration time of the signed URL, after which it is no longer valid.
 * @param [options] - Optional configuration options for generating the signed URL.
