 ...
 *
 * @param client         - The v3 S3 client used to list objects.
 * @param   bucketName     - The name of the S3 bucket.
 * @param   directoryPath  - The directory prefix to list.
 * @param [options]   - Additional parameters for `ListObjectsV2`.
 * @returns
