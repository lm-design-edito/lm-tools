 ...
 *
 * @param inputBuffer - The input data to encrypt.
 * @param encryptionKey - The encryption key to use.
 *
 * @returns The result of the encryption. Success returns the encrypted data as a `Buffer` (with IV prepended), or failure returns an error message.
 */
 ...
 *
 * @param encryptedBuffer - The encrypted data to decrypt.
 * @param encryptionKey - The encryption key to use.
 *
 * @returns The result of the decryption. Success returns the decrypted data as a `Buffer`, or failure returns an error message.
 */
